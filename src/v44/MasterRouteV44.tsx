...
import OmniversityLayerV44 from "../v44/OmniversityLayerV44"
...
export default function MasterRouteV44() {
  ...
  return (
    <section ref={rootRef} className="v43-master-route" aria-labelledby="v43-route-title">
      ...
      <OmniversityLayerV44 completedStageCodes={progress.completedStages} currentStageIndex={currentIndex} />
